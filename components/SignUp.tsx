...
interface SignUpProps {
  onSignUp: (email: string, displayName: string, password: string) => void;
  onBack: () => void;
...
const SignUp: React.FC<SignUpProps> = ({ onSignUp, onBack, onSocialLogin, existingUsers, language }) => {
  ...
  const isCtaDisabled = !email || password.length < 8 || password !== confirmPassword || !agreedToTerms;
